...
public class PeruActivity extends AppCompatActivity  implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagen = (ImageView) findViewById(R.id.imgperu);
    }
        ...
        switch (event.sensor.getType()) {
            case Sensor.TYPE_GYROSCOPE:
                ...
                if(event.values[2] > 0.5f) { // antihora
                    ...
                    imagen.getResources().getDrawable(R.mipmap.per2);


                } else if(event.values[2] < -0.5f) { // hora

                    imagen.getResources().getDrawable(R.mipmap.per3);
    ...
    public void salir(View view){
        ...
        Intent intent = new Intent(PeruActivity.this, MainActivity.class);
